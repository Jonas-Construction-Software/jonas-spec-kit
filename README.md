...
<p align="center">
    <a href="https://github.com/Jonas-Construction-Software/jonas-spec-kit/actions/workflows/release.yml"><img src="https://github.com/Jonas-Construction-Software/jonas-spec-kit/actions/workflows/release.yml/badge.svg" alt="Release"/></a>
    <a href="https://github.com/Jonas-Construction-Software/jonas-spec-kit/stargazers"><img src="https://img.shields.io/github/stars/Jonas-Construction-Software/jonas-spec-kit?style=social" alt="GitHub stars"/></a>
    <a href="https://github.com/Jonas-Construction-Software/jonas-spec-kit/blob/main/LICENSE"><img src="https://img.shields.io/github/license/Jonas-Construction-Software/jonas-spec-kit" alt="License"/></a>
    <a href="https://jonas-construction-software.github.io/jonas-spec-kit/"><img src="https://img.shields.io/badge/docs-GitHub_Pages-blue" alt="Documentation"/></a>
</p>
...
```bash
uv tool install specify-cli --from git+https://github.com/Jonas-Construction-Software/jonas-spec-kit.git
```
...
```bash
uv tool install specify-cli --force --from git+https://github.com/Jonas-Construction-Software/jonas-spec-kit.git
```
...
```bash
uvx --from git+https://github.com/Jonas-Construction-Software/jonas-spec-kit.git specify init <PROJECT_NAME>
```
...
| Command                 | Description                                                              |
| ----------------------- | ------------------------------------------------------------------------ |
| `/speckit.context`      | Gather research and implementation context before writing specifications  |
...
| Command              | Description                                                                                                                          |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `/speckit.clarify`   | Clarify underspecified areas (recommended after `/speckit.specify` and before `/speckit.plan`; formerly `/quizme`)                  |
...
For support, please open a [GitHub issue](https://github.com/Jonas-Construction-Software/jonas-spec-kit/issues/new). We welcome bug reports, feature requests, and questions about using Spec-Driven Development.

## 🙏 Acknowledgements

This project is a customized fork of [GitHub Spec Kit](https://github.com/github/spec-kit).

The original Spec Kit project is heavily influenced by and based on the work and research of [John Lam](https://github.com/jflam).
